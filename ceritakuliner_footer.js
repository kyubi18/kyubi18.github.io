...
document.write('<div id="floatads" style="width:100%;margin:auto;text-align:center;float:none;overflow:hidden;display:scroll;position:fixed;bottom:50px;z-index:99999;-webkit-transform:translateZ(0);"><div><a id="close-floatads" onclick="document.getElementById(&apos;floatads&apos;).style.display = &apos;none&apos;;" style="cursor:pointer;"><img alt="close" src="https://3.bp.blogspot.com/-ZZSacDHLWlM/VhvlKTMjbLI/AAAAAAAAF2M/UDzU4rrvcaI/s1600/btn_close.gif" title="close button"/></a></div><div style="text-align:center;display:block;max-width:300px;height:auto;overflow:hidden;margin:auto"><div id="banner-1"><script>googletag.cmd.push(function(){googletag.display("banner-1");});<\/script><\/div></div></div>');
